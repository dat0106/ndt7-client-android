...
public class Ndt7ServerSearchNearest {
    ...
    public Ndt7ServerSearchNearest(URL locateUrl) {
        this.locateUrl = locateUrl;
    }
    public Ndt7ServerSearchNearest() {
        try {
            this.locateUrl = new URL("https://locate.measurementlab.net/v2/nearest/ndt/ndt7");
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (response.networkResponse() != null) {
                    ...
                    if(response.networkResponse().code() != NOCAPACITY) {
                        ...
                        Log.e(getClass().getSimpleName(), "NO Capacity");
                    }
                }
